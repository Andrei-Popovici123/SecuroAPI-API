...
public class BasicAuthenticationHandler(
    ...
    UrlEncoder encoder,
    IUserService _userService) : AuthenticationHandler<AuthenticationSchemeOptions> (options, logger, encoder)
{
    protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
    {
        ...
        if (!result.IsSuccess) return AuthenticateResult.Fail("Invalid username or password");
