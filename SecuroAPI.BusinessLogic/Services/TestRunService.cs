...
public class TestRunService : ITestRunService
{
    ...
    public TestRunService(ITestConfigRepository configRepository, IRatingRepository ratingRepository, IAPIRegistryRepository apiRegistryRepository, IUserService userService, IScoreReportRepository apiScoreReportRepository)
    {
